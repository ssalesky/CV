...
% ---------------------------------------------
% Number publications?
% Ordering? Can (or should) awards go higher in order?
% ---------------------------------------------

%Header with my contact information
\begin{center}
...
% % Mechanical Version
% Turbulence, Large Eddy Simulation, Multiphase Flows,
% Wind Energy, Snow and Sediment Transport, Atmospheric Boundary Layer,
