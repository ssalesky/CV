...
% \ifdefined\includepagenumbers
%     \pagestyle{fancy}
%     \fancyfoot{}                        %Clear foter
%     \fancyhead{}                        %No header
%     \setcounter{page}{2}
%     \lfoot{\small S. T. Salesky }   %My name in header
%     \rfoot{\small \thepage\ of 9}   %My name in header
%     \renewcommand{\headrulewidth}{0pt}
% \fi
% %-------------------------------------------------
...
\begin{center}
    ...
    \end{tabular} \\
    Email: \texttt{scott.salesky@ubc.ca} %\\ \smallskip
    % For the most current copy of this CV, visit:\, {\href{http://goo.gl/V3tCfv}{\texttt{goo.gl/V3tCfv}}}
\end{center}
...
% 2009 &\textbf{Chi Epsilon Pi} \\
%      & Atmospheric Sciences Honor Society\\[1.5\parskip]
...
% Accepted by \textit{Journal of the Atmospheric Sciences}, in press.
...
%NOTE: Resubmitted first revision on September 8, 2016.

% \textbf{Salesky, S.T.}, M. Chamecki, and E. Bou-Zeid (2016) On the nature of
% the transition between roll and cellular organization in the convective
% boundary layer. Accepted by \textit{Boundary-Layer Meteorology}, in press.
% %NOTE: Resubmitted first revision on September 8, 2016.
...
% [\href{http://onlinelibrary.wiley.com/doi/10.1002/qj.2937/abstract}{\textsc{doi}}]
% [\href{http://onlinelibrary.wiley.com/doi/10.1002/qj.2937/abstract}{{link}}]
...
% surface layers. \textit{Journal of Fluid Mechanics}, \textbf{797}, R3. [\href{http://doi.org/10.1017/jfm.2016.311}{{link}}]
...
% [\href{http://doi.org/10.1002/qj.2472}{{link}}] 
...
% [\href{http://doi.org/10.1063/1.4823747}{{link}}]
...
% [\href{http://doi.org/10.1175/JAS-D-12-096.1}{{link}}]
...
% [\href{http://doi.org/10.1007/s10546-011-9618-0}{{link}}]
...
% [\href{http://doi.org/10.1007/s10546-012-9710-0}{{link}}]
...
% Giometto, M. G., J. Fang, \textbf{S. T. Salesky}, and M. B. Parlange, 2017.
% Large- and Very-Large-Scale Motions in Katabatic Flows Over Steep Slopes.
%   AMS Annual Meeting. Seattle, WA. January 22-26, 2017.

% \textbf{S.T. Salesky}, M.G. Giometto, A. Christen, and M.B. Parlange, 2017.
% Scalar dispersion from point sources and area in realistic urban
% environments.  AMS Annual Meeting. Seattle, WA. January 22-26, 2017.
...
% M.G. Giometto, J. Fang, \textbf{S.T. Salesky}, and M.B. Parlange, 2016.  Large-
% and very-large scale motions in katabatic flows over steep slopes.  AGU Fall
% Meeting. December 12-16, 2016.

% Parlange, M.B., M.G. Giometto, P. Egli, M.F. Schmidt, R.T. Tooke, 
% N.C. Coops, \textbf{S.T. Salesky}, and A. Christen, 2016. 
% Effects of urban trees on mean wind, turbulence and momentum exchange
% within and above a realistic urban canopy. AGU Fall Meeting. December 12-16, 2016.
